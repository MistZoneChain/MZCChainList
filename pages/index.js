...
function Home({ changeTheme, theme, sortedChains }) {
  ...
  const addNetwork = () => {
    window.open('https://github.com/MistZoneChain/MZCChainList/tree/main/utils/chains.json', '_blank');
  };

  const addRpc = () => {
    window.open('https://github.com/MistZoneChain/MZCChainList/tree/main/utils/extraRpcs.json', '_blank');
  };
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>MistZone Chain List</title>
        <link rel="icon" href={`${assetPrefix}/favicon.ico`} />
        <meta
          name="description"
          content="MistZone Chain List 是 MZC 网络的信息列表。 用户可以使用这些信息将他们的账户以正确的方式连接至迷踪链。"
        />
      </Head>
          ...
          <div className={classes.copyContainer}>
            <div className={classes.copyCentered}>
              ...
              <Button
                ...
                endIcon={<AddIcon />}
              >
                <Typography className={classes.buttonLabel}>添加网络</Typography>
              </Button>
              <Button
                size="large"
                color="primary"
                ...
                endIcon={<AddIcon />}
              >
                <Typography className={classes.buttonLabel}>添加RPC</Typography>
              </Button>
              <div className={classes.socials}>
                <a
                  className={`${classes.socialButton}`}
                  href="https://github.com/MistZoneChain/MZCChainList"
                  target="_blank"
